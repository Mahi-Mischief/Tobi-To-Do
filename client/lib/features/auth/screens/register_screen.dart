                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Center(
                            child: Image.asset(
                              'assets/tobi_animations/app_logo.png',
                              height: 48,
                        ...
                        const Text(
                          'Join Tobi and get focused.',
                          style: TextStyle(fontSize: 14, color: Color(0xFF6F7A89)),
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text('or', style: TextStyle(color: Color(0xFF9AA3B2))),
                            ),
                            Expanded(child: Divider(color: Colors.grey.shade300)),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: const Text('Log In', style: TextStyle(color: Color(0xFF3B82F6))),
                            ),
                          ],
                        ),
                      ],
